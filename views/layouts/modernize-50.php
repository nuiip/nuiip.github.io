...
?>
  ...
  <!-- Preloader -->
  <div class="preloader">
    <?= Html::img('@web/templates/modernize-50/assets/images/logos/favicon.png', ['class' => 'lds-ripple img-fluid', 'alt' => 'loader']) ?>
  </div>
  <div id="main-wrapper">
    <!-- Sidebar Start -->
      ...
      <div><!-- ---------------------------------- -->
        ...
        <div class="brand-logo d-flex align-items-center justify-content-between">
          ...
          <!-- <img src="./assets/images/logos/dark-logo.svg" class="dark-logo" alt="Logo-Dark" /> -->
            <?= Html::img('@web/templates/modernize-50/assets/images/logos/dark-logo.svg', ['class' => 'dark-logo', 'alt' => 'Logo-Dark']) ?>
            <!-- <img src="./assets/images/logos/light-logo.svg" class="light-logo" alt="Logo-light" /> -->
            <?= Html::img('@web/templates/modernize-50/assets/images/logos/light-logo.svg', ['class' => 'light-logo', 'alt' => 'Logo-Light']) ?>
          </a>
        ...
        <div class="fixed-profile p-3 mx-4 mb-2 bg-secondary-subtle rounded mt-3">
          <div class="hstack gap-3">
            <div class="john-img">
              ...
              <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-1.jpg', ['class' => 'rounded-circle', 'width' => '40', 'height' => '40', 'alt' => 'modernize-img']) ?>
            </div>
                              ...
                              <div class="col-6">
                                <div class="position-relative">
                                  <a href="./main/app-chat.html" class="d-flex align-items-center pb-9 position-relative">
                                    ...
                                    <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-dd-chat.svg', ['class' => 'img-fluid', 'width' => '24', 'height' => '24', 'alt' => 'modernize-img']) ?>
                                  ...
                                  <a href="./main/app-invoice.html" class="d-flex align-items-center pb-9 position-relative">
                                    ...
                                    <!-- <img src="./assets/images/svgs/icon-dd-invoice.svg" alt="modernize-img" class="img-fluid" width="24" height="24" /> -->
                                      <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-dd-invoice.svg', ['class' => 'img-fluid', 'width' => '24', 'height' => '24', 'alt' => 'modernize-img']) ?>
                                    </div>
                                    <div>
                                  ...
                                  <a href="./main/app-contact2.html" class="d-flex align-items-center pb-9 position-relative">
                                    ...
                                    <!-- <img src="./assets/images/svgs/icon-dd-mobile.svg" alt="modernize-img" class="img-fluid" width="24" height="24" /> -->
                                      <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-dd-mobile.svg', ['class' => 'img-fluid', 'width' => '24', 'height' => '24', 'alt' => 'modernize-img']) ?>
                                    </div>
                                    <div>
                                      <h6 class="mb-1 fw-semibold fs-3">
                                        Contact Application
                                  ...
                                  <a href="./main/app-email.html" class="d-flex align-items-center pb-9 position-relative">
                                    <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                      ...
                                      <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-dd-message-box.svg', ['class' => 'img-fluid', 'width' => '24', 'height' => '24', 'alt' => 'modernize-img']) ?>
                                    </div>
                                    <div>
                                ...
                                <div class="position-relative">
                                  <a href="./main/page-user-profile.html" class="d-flex align-items-center pb-9 position-relative">
                                    <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                      ...
                                      <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-dd-cart.svg', ['class' => 'img-fluid', 'width' => '24', 'height' => '24', 'alt' => 'modernize-img']) ?>
                                    </div>
                                    <div>
                                      <h6 class="mb-1 fw-semibold fs-3">
                                        User Profile
                                  ...
                                  <a href="./main/app-calendar.html" class="d-flex align-items-center pb-9 position-relative">
                                    <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                      ...
                                      <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-dd-date.svg', ['class' => 'img-fluid', 'width' => '24', 'height' => '24', 'alt' => 'modernize-img']) ?>
                                    </div>
                                    <div>
                                      <h6 class="mb-1 fw-semibold fs-3">
                                        Calendar App
                                  ...
                                  <a href="./main/app-contact.html" class="d-flex align-items-center pb-9 position-relative">
                                    <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                      ...
                                      <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-dd-lifebuoy.svg', ['class' => 'img-fluid', 'width' => '24', 'height' => '24', 'alt' => 'modernize-img']) ?>
                                    </div>
                                    <div>
                                      <h6 class="mb-1 fw-semibold fs-3">
                                        Contact List Table
                                  ...
                                  <a href="./main/app-notes.html" class="d-flex align-items-center pb-9 position-relative">
                                    <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                                      ...
                                      <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-dd-application.svg', ['class' => 'img-fluid', 'width' => '24', 'height' => '24', 'alt' => 'modernize-img']) ?>
                                    </div>
                                    <div>
                                      <h6 class="mb-1 fw-semibold fs-3">
                                        Notes Application
                ...
                <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
                  ...
                  <li class="nav-item nav-icon-hover-bg rounded-circle dropdown">
                    <a class="nav-link" href="javascript:void(0)" id="drop2" aria-expanded="false">
                      ...
                      <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-flag-en.svg', ['class' => 'rounded-circle object-fit-cover round-20', 'width' => '20px', 'height' => '20px', 'alt' => 'modernize-img']) ?>
                    </a>
                      ...
                      <div class="message-body">
                        ...
                        <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                          <div class="position-relative">
                            ...
                            <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-flag-cn.svg', ['class' => 'rounded-circle object-fit-cover round-20', 'width' => '20px', 'height' => '20px', 'alt' => 'modernize-img']) ?>
                          </div>
                        ...
                        <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                          <div class="position-relative">
                            ...
                            <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-flag-fr.svg', ['class' => 'rounded-circle object-fit-cover round-20', 'width' => '20px', 'height' => '20px', 'alt' => 'modernize-img']) ?>
                          </div>
                        ...
                        <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                          <div class="position-relative">
                            ...
                            <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-flag-sa.svg', ['class' => 'rounded-circle object-fit-cover round-20', 'width' => '20px', 'height' => '20px', 'alt' => 'modernize-img']) ?>
                          </div>
                      ...
                      <div class="message-body" data-simplebar>
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                            ...
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-2.jpg', ['class' => 'rounded-circle', 'width' => '48', 'height' => '48', 'alt' => 'user']) ?>
                          </span>
                          <div class="w-100">
                        ...
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                            ...
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-3.jpg', ['class' => 'rounded-circle', 'width' => '48', 'height' => '48', 'alt' => 'user']) ?>
                          </span>
                          <div class="w-100">
                        ...
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                            ...
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-4.jpg', ['class' => 'rounded-circle', 'width' => '48', 'height' => '48', 'alt' => 'user']) ?>
                          </span>
                          <div class="w-100">
                        ...
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                            ...
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-5.jpg', ['class' => 'rounded-circle', 'width' => '48', 'height' => '48', 'alt' => 'user']) ?>
                          </span>
                          <div class="w-100">
                        ...
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                            ...
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-6.jpg', ['class' => 'rounded-circle', 'width' => '48', 'height' => '48', 'alt' => 'user']) ?>
                          </span>
                          <div class="w-100">
                        ...
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                            ...
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-7.jpg', ['class' => 'rounded-circle', 'width' => '48', 'height' => '48', 'alt' => 'user']) ?>
                          </span>
                          <div class="w-100">
                            <h6 class="mb-1 fw-semibold lh-base">Roman Joined the Team!</h6>
                            <span class="fs-2 d-block text-body-secondary">Congratulate him</span>
                    ...
                    <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" aria-expanded="false">
                      <div class="d-flex align-items-center">
                        <div class="user-profile-img">
                          ...
                          <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-1.jpg', ['class' => 'rounded-circle', 'width' => '35', 'height' => '35', 'alt' => 'user']) ?>
                        </div>
                      </div>
                    </a>
                    <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
                      <div class="profile-dropdown position-relative" data-simplebar>
                        ...
                        <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                          ...
                          <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-1.jpg', ['class' => 'rounded-circle', 'width' => '80', 'height' => '80', 'alt' => 'user']) ?>
                          <div class="ms-3">
                        ...
                        <div class="message-body">
                          <a href="./main/page-user-profile.html" class="py-8 px-7 mt-8 d-flex align-items-center">
                            <span class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                              ...
                              <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-account.svg', ['width' => '24', 'height' => '24', 'alt' => 'modernize-img']) ?>
                            </span>
                          ...
                          <a href="./main/app-email.html" class="py-8 px-7 d-flex align-items-center">
                            <span class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                              ...
                              <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-inbox.svg', ['width' => '24', 'height' => '24', 'alt' => 'modernize-img']) ?>
                            </span>
                            <div class="w-100 ps-3">
                          ...
                          <a href="./main/app-notes.html" class="py-8 px-7 d-flex align-items-center">
                            <span class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
                              ...
                              <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-tasks.svg', ['width' => '24', 'height' => '24', 'alt' => 'modernize-img']) ?>
                            </span>
                            <div class="w-100 ps-3">
                            ...
                            <div class="row">
                              ...
                              <div class="col-6">
                                <div class="m-n4 unlimited-img">
                                  ...
                                  <?= Html::img('@web/templates/modernize-50/assets/images/backgrounds/unlimited-bg.png', ['class' => 'w-100', 'alt' => 'modernize-img']) ?>
                                </div>
                              </div>
                            </div>
                          </div>
          ...
          <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="mobilenavbar" aria-labelledby="offcanvasWithBothOptionsLabel">
            <nav class="sidebar-nav scroll-sidebar">
              <div class="offcanvas-header justify-content-between">
                ...
                <?= Html::img('@web/templates/modernize-50/assets/images/logos/favicon.ico', ['class' => 'img-fluid', 'alt' => 'modernize-img']) ?>
          ...
          <nav class="navbar navbar-expand-xl container-fluid p-0">
            <ul class="navbar-nav align-items-center">
              ...
              <li class="nav-item d-none d-xl-block">
                <a href="./main/index.html" class="text-nowrap nav-link">
                  ...
                  <?= Html::img('@web/templates/modernize-50/assets/images/logos/dark-logo.svg', ['class' => 'dark-logo', 'width' => '180', 'alt' => 'modernize-img']) ?>
                  <!-- <img src="./assets/images/logos/light-logo.svg" class="light-logo" width="180" alt="modernize-img" /> -->
                  <?= Html::img('@web/templates/modernize-50/assets/images/logos/light-logo.svg', ['class' => 'light-logo', 'width' => '180', 'alt' => 'modernize-img']) ?>
                </a>
              </li>
            ...
            <div class="d-block d-xl-none">
              <a href="./main/index.html" class="text-nowrap nav-link">
                ...
                <?= Html::img('@web/templates/modernize-50/assets/images/logos/dark-logo.svg', ['class' => 'img-fluid', 'width' => '180', 'alt' => 'modernize-img']) ?>
              </a>
            </div>
            <a class="navbar-toggler nav-icon-hover-bg rounded-circle p-0 mx-0 border-0" href="javascript:void(0)" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
              <span class="p-2">
                    ...
                    <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                      ...
                      <div class="message-body" data-simplebar>
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                            <!-- <img src="./assets/images/profile/user-2.jpg" alt="user" class="rounded-circle" width="48" height="48" /> -->
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-2.jpg', ['class' => 'rounded-circle', 'width' => '48', 'height' => '48', 'alt' => 'modernize-img']) ?>
                          </span>
                          <div class="w-100">
                            <h6 class="mb-1 fw-semibold lh-base">Roman Joined the Team!</h6>
                            <span class="fs-2 d-block text-body-secondary">Congratulate him</span>
                        ...
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                            <!-- <img src="./assets/images/profile/user-3.jpg" alt="user" class="rounded-circle" width="48" height="48" /> -->
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-3.jpg', ['class' => 'rounded-circle', 'width' => '48', 'height' => '48', 'alt' => 'modernize-img']) ?>
                          </span>
                          <div class="w-100">
                            <h6 class="mb-1 fw-semibold lh-base">New message</h6>
                            <span class="fs-2 d-block text-body-secondary">Salma sent you new message</span>
                        ...
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                            <!-- <img src="./assets/images/profile/user-4.jpg" alt="user" class="rounded-circle" width="48" height="48" /> -->
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-4.jpg', ['class' => 'rounded-circle', 'width' => '48', 'height' => '48', 'alt' => 'modernize-img']) ?>
                          </span>
                          <div class="w-100">
                            <h6 class="mb-1 fw-semibold lh-base">Bianca sent payment</h6>
                            <span class="fs-2 d-block text-body-secondary">Check your earnings</span>
                        ...
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                            <!-- <img src="./assets/images/profile/user-5.jpg" alt="user" class="rounded-circle" width="48" height="48" /> -->
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-5.jpg', ['class' => 'rounded-circle', 'width' => '48', 'height' => '48', 'alt' => 'modernize-img']) ?>
                          </span>
                          <div class="w-100">
                            <h6 class="mb-1 fw-semibold lh-base">Jolly completed tasks</h6>
                            <span class="fs-2 d-block text-body-secondary">Assign her new tasks</span>
                        ...
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                            <!-- <img src="./assets/images/profile/user-6.jpg" alt="user" class="rounded-circle" width="48" height="48" /> -->
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-6.jpg', ['class' => 'rounded-circle', 'width' => '48', 'height' => '48', 'alt' => 'modernize-img']) ?>
                          </span>
                          <div class="w-100">
                            <h6 class="mb-1 fw-semibold lh-base">John received payment</h6>
                            <span class="fs-2 d-block text-body-secondary">$230 deducted from account</span>
                        ...
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                            <!-- <img src="./assets/images/profile/user-7.jpg" alt="user" class="rounded-circle" width="48" height="48" /> -->
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-7.jpg', ['class' => 'rounded-circle', 'width' => '48', 'height' => '48', 'alt' => 'modernize-img']) ?>
                          </span>
                          <div class="w-100">
                            <h6 class="mb-1 fw-semibold lh-base">Roman Joined the Team!</h6>
                            <span class="fs-2 d-block text-body-secondary">Congratulate him</span>
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" aria-expanded="false">
                      <div class="d-flex align-items-center">
                        <div class="user-profile-img">
                          <!-- <img src="./assets/images/profile/user-1.jpg" class="rounded-circle" width="35" height="35" alt="modernize-img" /> -->
                          <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-1.jpg', ['class' => 'rounded-circle', 'width' => '35', 'height' => '35', 'alt' => 'modernize-img']) ?>
                        </div>
                      </div>
                    </a>
                    <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
                      <div class="profile-dropdown position-relative" data-simplebar>
                        ...
                        <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                          <!-- <img src="./assets/images/profile/user-1.jpg" class="rounded-circle" width="80" height="80" alt="modernize-img" /> -->
                          <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-1.jpg', ['class' => 'rounded-circle', 'width' => '80', 'height' => '80', 'alt' => 'modernize-img']) ?>
                          <div class="ms-3">
                            <h5 class="mb-1 fs-3">Mathew Anderson</h5>
                            <span class="mb-1 d-block">Designer</span>
                            <p class="mb-0 d-flex align-items-center gap-2">
        ...
        <ul class="mb-0">
          <li class="pb-7">
            <div class="d-flex align-items-center">
              ...
              <?= Html::img('@web/templates/modernize-50/assets/images/products/product-1.jpg', ['class' => 'rounded-1 me-9 flex-shrink-0', 'width' => '75', 'height' => '75', 'alt' => 'modernize-img']) ?>
              <div>
          ...
          <li class="pb-7">
            <div class="d-flex align-items-center">
              ...
              <?= Html::img('@web/templates/modernize-50/assets/images/products/product-2.jpg', ['class' => 'rounded-1 me-9 flex-shrink-0', 'width' => '75', 'height' => '75', 'alt' => 'modernize-img']) ?>
              <div>
                <h6 class="mb-1">Supreme toys cooker</h6>
                <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                <div class="d-flex align-items-center justify-content-between mt-2">
          ...
          <li class="pb-7">
            <div class="d-flex align-items-center">
              ...
              <?= Html::img('@web/templates/modernize-50/assets/images/products/product-3.jpg', ['class' => 'rounded-1 me-9 flex-shrink-0', 'width' => '75', 'height' => '75', 'alt' => 'modernize-img']) ?>
              <div>
                <h6 class="mb-1">Supreme toys cooker</h6>
                <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                <div class="d-flex align-items-center justify-content-between mt-2">
	...
	$this->registerJs(
		"
			$( document ).ready(function() {
				...
				if (lightMode){
					$('html').attr('data-bs-theme', lightMode);
					if (lightMode == 'dark') {
						$('body').removeClass('light');
            $('.dark-layout').css('display', 'none');
            $('.ti.ti-sun.moon').css('display', 'none');
            $('.light-layout').css('display', 'flex');
            $('.ti.ti-sun.sun').css('display', 'flex');
					} else {
						$('body').removeClass('dark');
            $('.light-layout').css('display', 'none');
            $('.ti.ti-sun.sun').css('display', 'none');
            $('.dark-layout').css('display', 'flex');
            $('.ti.ti-sun.moon').css('display', 'flex');
					}
