...
<div class="finbooks-default-index">
    ...
    <div class="owl-carousel counter-carousel owl-theme">
        <div class="item">
            ...
            <div class="card-body">
                ...
                <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-user-male.svg', ['class' => 'mb-3', 'width' => '50', 'height' => '50', 'alt' => 'modernize-img']) ?>
        ...
        <div class="item">
            ...
            <div class="card-body">
                ...
                <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-briefcase.svg', ['class' => 'mb-3', 'width' => '50', 'height' => '50', 'alt' => 'modernize-img']) ?>
        ...
        <div class="item">
            ...
            <div class="card-body">
                ...
                <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-mailbox.svg', ['class' => 'mb-3', 'width' => '50', 'height' => '50', 'alt' => 'modernize-img']) ?>
        ...
        <div class="item">
            ...
            <div class="card-body">
                ...
                <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-favorites.svg', ['class' => 'mb-3', 'width' => '50', 'height' => '50', 'alt' => 'modernize-img']) ?>
        ...
        <div class="item">
            ...
            <div class="card-body">
                ...
                <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-speech-bubble.svg', ['class' => 'mb-3', 'width' => '50', 'height' => '50', 'alt' => 'modernize-img']) ?>
        ...
        <div class="item">
            ...
            <div class="card-body">
                ...
                <?= Html::img('@web/templates/modernize-50/assets/images/svgs/icon-connect.svg', ['class' => 'mb-3', 'width' => '50', 'height' => '50', 'alt' => 'modernize-img']) ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 d-flex align-items-stretch flex-column">
            ...
            <div class="card-body">
                ...
                <div class="me-3 pe-1">
                    ...
                    <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-2.jpg', ['class' => 'shadow-warning rounded-2', 'width' => '72', 'height' => '72', 'alt' => 'modernize-img']) ?>
                </div>
                <div>
                ...
                <ul class="hstack mb-0">
                    ...
                    <a href="javascript:void(0)" class="me-1">
                        ...
                        <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-2.jpg', ['class' => 'rounded-circle border border-2 border-white', 'width' => '44', 'height' => '44', 'alt' => 'modernize-img']) ?>
                    </a>
                    </li>
                    <li class="ms-n8">
                    <a href="javascript:void(0)" class="me-1">
                        ...
                        <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-3.jpg', ['class' => 'rounded-circle border border-2 border-white', 'width' => '44', 'height' => '44', 'alt' => 'modernize-img']) ?>
                    </a>
                    </li>
                    <li class="ms-n8">
                    <a href="javascript:void(0)" class="me-1">
                        ...
                        <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-4.jpg', ['class' => 'rounded-circle border border-2 border-white', 'width' => '44', 'height' => '44', 'alt' => 'modernize-img']) ?>
                    </a>
                    </li>
                    <li class="ms-n8">
                    <a href="javascript:void(0)" class="me-1">
                        ...
                        <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-5.jpg', ['class' => 'rounded-circle border border-2 border-white', 'width' => '44', 'height' => '44', 'alt' => 'modernize-img']) ?>
                    </a>
                    </li>
                </ul>
        ...
        <div class="col-lg-4 d-flex align-items-stretch">
            ...
            <div class="card-body pb-0">
                ...
                <?= Html::img('@web/templates/modernize-50/assets/images/backgrounds/piggy.png', ['class' => 'img-fluid', 'alt' => 'modernize-img']) ?>
                </div>
            </div>
                ...
                <table class="table align-middle text-nowrap mb-0">
                    ...
                    <tr>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-3.jpg', ['class' => 'rounded-circle', 'width' => '40', 'height' => '40', 'alt' => 'modernize-img']) ?>
                            </div>
                            <div>
                    ...
                    <tr>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-5.jpg', ['class' => 'rounded-circle', 'width' => '40', 'height' => '40', 'alt' => 'modernize-img']) ?>
                            </div>
                            <div>
                    ...
                    <tr>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-6.jpg', ['class' => 'rounded-circle', 'width' => '40', 'height' => '40', 'alt' => 'modernize-img']) ?>
                            </div>
                            <div>
                    ...
                    <tr>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-7.jpg', ['class' => 'rounded-circle', 'width' => '40', 'height' => '40', 'alt' => 'modernize-img']) ?>
                            </div>
                            <div>
                    ...
                    <tr>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <?= Html::img('@web/templates/modernize-50/assets/images/profile/user-8.jpg', ['class' => 'rounded-circle', 'width' => '40', 'height' => '40', 'alt' => 'modernize-img']) ?>
                            </div>
                            <div>
...
<?php
    $this->registerJsFile(
        '@web/templates/modernize-50/assets/libs/owl.carousel/dist/owl.carousel.min.js',
        ['depends' => [\yii\web\JqueryAsset::class]]
    );
    $this->registerJsFile(
        '@web/templates/modernize-50/assets/libs/apexcharts/dist/apexcharts.min.js',
        ['depends' => [\yii\web\JqueryAsset::class]]
    );
    $this->registerJsFile(
        '@web/templates/modernize-50/assets/js/dashboards/dashboard.js',
        ['depends' => [\yii\web\JqueryAsset::class]]
    );
?>